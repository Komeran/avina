    ...
    execute: function(args, message) {
        ...
        for(let g in games[gid]) {
            if(games[gid][g].dm === message.author.id) {
                ...
                games[gid][g].quests[id-1].completed = !games[gid][g].quests[id-1].completed;
                message.channel.send({
                    embed: {
                        title: "Quest of game " + games[gid][g].session + " has been " + (games[gid][g].quests[id-1].completed ? "" : "un") + "completed!",
